...
def err(code, source, c, i):
    ...
    if c == "f":
        ...
        f.write("\nA fatal error had occured while CALC was is use so CALC was stopped. Below are details on said crash.")
        f.write("\n")
        ...
        f.write("\nDefinition: " + define)
        f.write("\nSource: " + source)
        f.write("\nComments: Replace this part with your comments including what happened.")
        f.write("\n")
